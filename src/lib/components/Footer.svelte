...
<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-col md:flex-row justify-between items-center md:items-start space-y-6 md:space-y-0">
      ...
      <!-- Sección de Derechos de Autor y Marca -->
      <div class="flex flex-col items-center md:items-start">
        <span class="text-lg font-bold text-gray-900 dark:text-white">Servicios digitales Rana</span>
      ...
      <div class="flex flex-col items-center md:items-start space-y-3">
        <!-- Enlace de correo -->
        <a 
          href="mailto:andressolisbautista15@gmail.com" 
      ...
      <div class="flex space-x-5 items-center mt-4 md:mt-0">
        <!-- GitHub -->
        <a 
          href="https://github.com/andressb98" 
          target="_blank" 
        ...
        <!-- LinkedIn (Recuerda colocar tu enlace real en href="#") -->
        <a 
          href="#" 
          target="_blank" 
          rel="noopener noreferrer" 
          class="text-gray-400 hover:text-[#0A66C2] dark:hover:text-[#3b82f6] transition-colors"
